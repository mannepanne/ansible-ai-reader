...
- [Upstream migration packet `2026-04-threat-model-and-safety-harness`](https://github.com/mannepanne/useful-assets-template/blob/main/REFERENCE/TEMPLATE-UPDATES/2026-04-threat-model-and-safety-harness/README.md) on `mannepanne/useful-assets-template` — the migration packet that shipped these allow-list entries; its manifest description references this principle when documenting the validation-tooling group.
