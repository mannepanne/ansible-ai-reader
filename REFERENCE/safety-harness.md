...
Implementation history and the full review trail are in upstream PR [#24](https://github.com/mannepanne/useful-assets-template/pull/24) on `mannepanne/useful-assets-template`.
